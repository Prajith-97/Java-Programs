...
public class secondLargest
{
    ...
    {
        System.out.println(secondLarge(new int[] {45, 51, 28, 75, 49, 42}));

        System.out.println(secondLarge(new int[] {985, 521, 975, 831, 479, 861}));

        System.out.println(secondLarge(new int[] {9459, 9575, 5692, 1305, 1942, 9012}));

        System.out.println(secondLarge(new int[] {47498, 14526, 74562, 42681, 75283, 45796}));
    }
}